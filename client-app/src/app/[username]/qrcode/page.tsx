...
const Page = () => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      try {
        const stealthResponse = await axios.post(
          `/api/stealth`, // Use our proxy API route
          {
  ...
  if (!showQRCode) {
    return (
      <div className=" flex items-center justify-center p-6 mt-32">
  ...
  return (
    <div className=" flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        {/* QR Code Section */}
        <div className="bg-foreground border p-10 border-border mb-6 text-center">
          {qrCodeUrl && (
            <img
              src={qrCodeUrl}
              alt="Payment QR Code"
