...
function initializeClients() {
    ...
    publicClients.set(chains_1.CHAIN_IDS.POLYGON_AMOY, (0, viem_1.createPublicClient)({
        chain: chains_1.POLYGON_AMOY,
        transport: (0, viem_1.http)('https://rpc-amoy.polygon.technology/'),
    }));
...
async function getTokenSymbol(tokenAddress, chainId) {
    try {
        ...
        if (tokenAddress === '0x0000000000000000000000000000000000000000') {
            switch (chainId) {
                case chains_1.CHAIN_IDS.POLYGON_AMOY: return 'POL';
                default: return 'POL';
            }
        }
...
async function getTokenName(tokenAddress, chainId) {
    try {
        ...
        if (tokenAddress === '0x0000000000000000000000000000000000000000') {
            switch (chainId) {
                case chains_1.CHAIN_IDS.POLYGON_AMOY: return 'Polygon';
...
function getRpcUrlForChain(chainId) {
    switch (chainId) {
        case chains_1.CHAIN_IDS.POLYGON_AMOY:
